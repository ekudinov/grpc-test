...
import (
	...
	"github.com/ekudinov/grpc-test/backend/calculator/service/handlers"
...
func NewEndpoints(service pb.CalculatorServer) svc.Endpoints {
	// Business domain.
	...
	// Endpoint domain.
	var (
		addEndpoint = svc.MakeAddEndpoint(service)
		subEndpoint = svc.MakeSubEndpoint(service)
	)
